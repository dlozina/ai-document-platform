...
from src.utils import (
    calculate_file_hash, detect_file_type, validate_file_content,
    generate_storage_path, sanitize_filename, format_file_size,
    FileValidator, extract_file_metadata
)
from src.storage import MinIOManager
from src.database import DatabaseManager, Document, ProcessingJob
...
class TestUtils:
    ...
    def test_validate_file_content(self, sample_image, sample_pdf):
        ...
        result = validate_file_content(b"invalid content", "test.pdf", "application/pdf")
...
class TestMinIOManager:
    ...
    def test_upload_file_success(self, mock_minio, sample_image):
        ...
        result = manager.upload_file("tenant123", "path/file.png", sample_image, "image/png")
...
class TestProcessingPipeline:
    ...
    async def test_process_document_ocr_success(self, mock_client_class, mock_get_db_manager, sample_image):
