...
class MinIOManager:
    ...
    def upload_file(
        self, tenant_id: str, file_path: str, file_content: bytes, content_type: str
    ) -> bool:
        """
    ...
    def download_file(self, tenant_id: str, file_path: str) -> bytes | None:
        """
    ...
    def get_file_info(self, tenant_id: str, file_path: str) -> dict[str, Any | None]:
        """
    ...
    def list_files(
        self, tenant_id: str, prefix: str = "", recursive: bool = True
    ) -> list[dict[str, Any]]:
        """
