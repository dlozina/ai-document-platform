...
def mock_query_processor():
    ...
    with patch("src.main.query_processor") as mock:
        ...
        processor.extract_answer_span.return_value = (
            "Python is a programming language.",
            0.9,
        )
        processor.generate_rag_answer.return_value = (
            "Based on the documents, Python is a programming language.",
            0.85,
        )
...
def sample_query_request():
    ...
    return {
        ...
        "top_k": 10,
        "score_threshold": 0.7,
        "filter": {"tenant_id": "test-tenant", "content_type": "application/pdf"},
    }
...
class TestQueryEndpoint:
    ...
    def test_extractive_qa_query(self, mock_query_processor):
        ...
        request = {"query": "What is Python?", "mode": "extractive_qa", "top_k": 5}
    ...
    def test_rag_query(self, mock_query_processor):
        """Test RAG query."""
        request = {"query": "Explain Python programming", "mode": "rag", "top_k": 3}
...
class TestSemanticSearchEndpoint:
    ...
    def test_semantic_search_success(self, mock_query_processor):
        ...
        request = {"query": "Python programming", "top_k": 10, "score_threshold": 0.7}
    ...
    def test_semantic_search_with_filter(self, mock_query_processor):
        ...
        request = {
            ...
            "top_k": 5,
            "filter": {"tenant_id": "test-tenant", "file_type": "pdf"},
        }
...
class TestQAEndpoint:
    ...
    def test_extractive_qa_success(self, mock_query_processor):
        ...
        request = {"question": "What is Python?", "mode": "extractive_qa", "top_k": 5}
...
class TestErrorHandling:
    ...
    def test_invalid_query_mode(self, mock_query_processor):
        ...
        request = {"query": "test query", "mode": "invalid_mode"}
    ...
    def test_query_processor_exception(self, mock_query_processor):
        ...
        request = {"query": "test query", "mode": "semantic_search"}
...
class TestQueryProcessor:
    ...
    def test_query_processor_initialization(
        self, mock_spacy, mock_engine, mock_qdrant, mock_sentence_transformer
    ):
