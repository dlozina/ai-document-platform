...
class TestEmbeddingProcessor:
    ...
    def mock_processor(self):
        ...
        with patch('src.embedding_processor.SentenceTransformer') as mock_model, \
    ...
    def test_generate_embedding(self, mock_processor):
        ...
        mock_processor.model.encode.assert_called_once_with(text, convert_to_tensor=False)
    ...
    def test_generate_batch_embeddings(self, mock_processor):
        ...
        mock_processor.model.encode.assert_called_once_with(texts, convert_to_tensor=False)
    ...
    def test_health_check_qdrant_failure(self, mock_processor):
        ...
        mock_processor.model.encode.return_value = np.array([0.1, 0.2, 0.3])
        mock_processor.qdrant_client.get_collections.side_effect = Exception("Qdrant error")
