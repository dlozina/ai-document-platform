    ...
    test_cases = [
        {
            ...
            "data": {
                "text": "This is a simple test sentence for embedding generation."
            },
        },
        {
    ...
    for test_case in test_cases:
        ...
        try:
            ...
            if response.status_code == 200:
                data = response.json()
                print(
                    f"  ✅ Success - Embedding dimension: {data['embedding_dimension']}"
                )
...
def test_batch_embed_endpoint():
    ...
    test_cases = [
        ...
        },
        {
            ...
            "data": {
                "texts": ["Metadata test one.", "Metadata test two."],
...
def test_search_endpoint():
    ...
    search_queries = [
        ...
        },
        {
            ...
            "data": {"query": "neural networks", "limit": 5, "score_threshold": 0.5},
        },
        {
    ...
    for test in error_tests:
        ...
        try:
            ...
            if response.status_code == test["expected_status"]:
                print(
                    f"  ✅ Correctly handled error (expected {test['expected_status']})"
                )
            else:
                print(
                    f"  ⚠️  Unexpected status code (expected {test['expected_status']})"
                )
