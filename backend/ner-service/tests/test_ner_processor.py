...
def ner_processor():
    ...
    with patch('spacy.load') as mock_load:
        ...
        processor = NERProcessor(model_name="en_core_web_sm", fallback_model="en_core_web_lg")
        return processor
...
class TestNERProcessor:
    ...
    def test_get_entity_statistics(self, ner_processor):
        ...
        org_count = next(et for et in stats['entity_types'] if et['entity_type'] == 'ORG')
        person_count = next(et for et in stats['entity_types'] if et['entity_type'] == 'PERSON')
...
@pytest.mark.parametrize("model_name,fallback_model", [
