...
class TestAuthenticationEndpoints:
    ...
    def test_login_success(self, mock_db_session, sample_user_data):
        ...
        with patch('src.database.user_manager.authenticate_user', return_value=mock_user):
    ...
    def test_refresh_token_invalid(self):
        ...
        with patch('src.auth.auth_manager.verify_token', side_effect=Exception("Invalid token")):
            response = client.post("/auth/refresh", json={
...
class TestUserManagementEndpoints:
    ...
    def test_create_user_duplicate(self, mock_db_session, admin_user_data):
        ...
        with patch('src.auth.get_current_user') as mock_auth:
            ...
            with patch('src.database.user_manager.create_user', side_effect=ValueError("Username or email already exists")):
                response = client.post("/users", json=admin_user_data)
    ...
    def test_get_user_by_id(self, mock_db_session):
        ...
        with patch('src.auth.get_current_user') as mock_auth:
            ...
            with patch('src.database.user_manager.get_user_by_id', return_value=mock_user):
...
class TestRateLimiting:
    ...
    def test_rate_limit_check(self, mock_redis):
        ...
        with patch('src.auth.rate_limiter.is_rate_limited', return_value=(False, {
            "limit": 60,
            "remaining": 59,
    ...
    def test_rate_limit_exceeded(self, mock_redis):
        ...
        with patch('src.auth.rate_limiter.is_rate_limited', return_value=(True, {
            "limit": 60,
            "remaining": 0,
            "reset_time": "2024-01-01T00:01:00",
            "retry_after": 60
...
class TestServiceProxy:
    ...
    def test_proxy_request_success(self, mock_redis):
        ...
        with patch('src.auth.get_current_user') as mock_auth:
            ...
            with patch('src.auth.service_proxy.proxy_request', return_value={
                "status_code": 200,
                "headers": {"content-type": "application/json"},
                "data": {"message": "success"},
                "content_type": "application/json"
            }):
                response = client.post("/proxy/ingestion/health", json={
                    "method": "GET",
                    "url": "/health"
                })
    ...
    def test_proxy_request_service_not_found(self, mock_redis):
        ...
        with patch('src.auth.get_current_user') as mock_auth:
            ...
            with patch('src.auth.service_proxy.proxy_request', side_effect=Exception("Service 'unknown' not found")):
                response = client.post("/proxy/unknown/health", json={
                    "method": "GET",
                    "url": "/health"
                })
