...
from src.models import UserCreate, UserUpdate, UserRole
...
class TestUserManager:
    ...
    def test_authenticate_user_success(self):
        ...
        with patch('src.database.auth_manager') as mock_auth:
            ...
            result = self.user_manager.authenticate_user(self.mock_db, "testuser", "password")
    ...
    def test_authenticate_user_wrong_password(self):
        ...
        with patch('src.database.auth_manager') as mock_auth:
            ...
            result = self.user_manager.authenticate_user(self.mock_db, "testuser", "wrongpassword")
    ...
    def test_authenticate_user_not_found(self):
        ...
        result = self.user_manager.authenticate_user(self.mock_db, "nonexistent", "password")
    ...
    def test_get_users_pagination(self):
        ...
        self.mock_db.query.return_value.offset.return_value.limit.assert_called_once_with(20)
